...
# CLEMENTINE-CLI
CLEMENTINE_CLI_URL="https://github.com/hirokuma/clementine-cli-regtest/releases/download/v0.1.0-hirokuma-withdraw/clementine-cli-regtest-linux64"
...
if [[ ! -f bitvm_cache.bin ]]; then
  ...
  ./target/debug/clementine-core generate-bitvm-cache
else
...
if [[ $cnt -eq 0 ]]; then
  echo "🌞You don't have clementine docker image."
